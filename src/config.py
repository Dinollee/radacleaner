...
{{
  ...
  "detailed_risks": [
    "Конкретний ризик: посилання на статтю/пункт закону + опис наслідків. Наприклад: 'ст. 15 п.3 — невизначені критерії відбору отримувачів коштів, що створює корупційні ризики при розподілі бюджетних资源'"
  ],
